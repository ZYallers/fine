...
func doMapConvert(value interface{}, recursive recursiveType, mustMapReturn bool, option ...MapOption) map[string]interface{} {
	...
	var (
		...
		newTags    = ftag.StructTagPriority
	)
	if usedOption.Deep {
	...
	case 0:
		// No need handling.
	case 1:
		newTags = append(strings.Split(usedOption.Tags[0], ","), ftag.StructTagPriority...)
	default:
		newTags = append(usedOption.Tags, ftag.StructTagPriority...)
	}
