...
func (csi *CachedStructInfo) genFieldConvertFunc(fieldType string) (convertFunc func(from interface{}, to reflect.Value)) {
	if fieldType[0] == '*' {
	...
	case "int", "int8", "int16", "int32", "int64":
		convertFunc = func(from interface{}, to reflect.Value) {
	...
	case "FTime", "ftime.Time":
		convertFunc = func(from interface{}, to reflect.Value) {
			v := localCommonConverter.FTime(from)
			if v == nil {
				v = ftime.New()
			}
			*to.Addr().Interface().(*ftime.Time) = *v
		}
	case "bool":
		convertFunc = func(from interface{}, to reflect.Value) {
...
func (csi *CachedStructInfo) genPtrConvertFunc(
	convertFunc func(from interface{}, to reflect.Value),
) func(from interface{}, to reflect.Value) {
	return func(from interface{}, to reflect.Value) {
		if to.IsNil() {
