// Package ftag providing tag content storing for struct.
//
...
const (
	...
	FConv                = "fconv"           // FConv defines the converting target name for specified struct field.
	FConvShort           = "c"               // FConv defines the converting target name for specified struct field.
...
var StructTagPriority = []string{
	FConv, Param, FConvShort, ParamShort, Json,
}
