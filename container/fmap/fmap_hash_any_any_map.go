...
func (m *AnyAnyMap) GetVar(key interface{}) *fvar.Var {
	return fvar.New(m.Get(key))
}

// GetVarOrSet returns a Var with result from GetOrSet.
// The returned Var is un-concurrent safe.
func (m *AnyAnyMap) GetVarOrSet(key interface{}, value interface{}) *fvar.Var {
	return fvar.New(m.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a Var with result from GetOrSetFunc.
// The returned Var is un-concurrent safe.
func (m *AnyAnyMap) GetVarOrSetFunc(key interface{}, f func() interface{}) *fvar.Var {
	return fvar.New(m.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a Var with result from GetOrSetFuncLock.
// The returned Var is un-concurrent safe.
func (m *AnyAnyMap) GetVarOrSetFuncLock(key interface{}, f func() interface{}) *fvar.Var {
...
func (m AnyAnyMap) MarshalJSON() ([]byte, error) {
	return json.Marshal(fconv.Map(m.Map()))
}
