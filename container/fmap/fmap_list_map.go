...
type ListMap struct {
	mu   rwmutex.RWMutex
	data map[interface{}]*flist.Element
	list *flist.List
}
...
func NewListMap(safe ...bool) *ListMap {
	return &ListMap{
		...
		data: make(map[interface{}]*flist.Element),
		list: flist.New(),
	}
}
...
func (m *ListMap) IteratorAsc(f func(key interface{}, value interface{}) bool) {
	...
	if m.list != nil {
		...
		m.list.IteratorAsc(func(e *flist.Element) bool {
...
func (m *ListMap) IteratorDesc(f func(key interface{}, value interface{}) bool) {
	...
	if m.list != nil {
		var node *gListMapNode
		m.list.IteratorDesc(func(e *flist.Element) bool {
			node = e.Value.(*gListMapNode)
			return f(node.key, node.value)
		})
	}
...
func (m *ListMap) Clear() {
	m.mu.Lock()
	m.data = make(map[interface{}]*flist.Element)
	m.list = flist.New()
	m.mu.Unlock()
}
...
func (m *ListMap) MapStrAny() map[string]interface{} {
	...
	if m.list != nil {
		...
		m.list.IteratorAsc(func(e *flist.Element) bool {
			node = e.Value.(*gListMapNode)
			data[fconv.String(node.key)] = node.value
			return true
		})
	}
	m.mu.RUnlock()
...
func (m *ListMap) GetVar(key interface{}) *fvar.Var {
	return fvar.New(m.Get(key))
}

// GetVarOrSet returns a Var with result from GetVarOrSet.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSet(key interface{}, value interface{}) *fvar.Var {
	return fvar.New(m.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a Var with result from GetOrSetFunc.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSetFunc(key interface{}, f func() interface{}) *fvar.Var {
	return fvar.New(m.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a Var with result from GetOrSetFuncLock.
// The returned Var is un-concurrent safe.
func (m *ListMap) GetVarOrSetFuncLock(key interface{}, f func() interface{}) *fvar.Var {
...
func (m *ListMap) Merge(other *ListMap) {
	...
	var node *gListMapNode
	other.list.IteratorAsc(func(e *flist.Element) bool {
		node = e.Value.(*gListMapNode)
