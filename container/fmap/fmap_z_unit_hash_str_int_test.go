...
func Test_StrIntMap_Basic(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		m2 := fmap.NewStrIntMapFrom(map[string]int{"a": 1, "b": 2})
...
func Test_StrIntMap_Iterator_Deadlock(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		m := fmap.NewStrIntMapFrom(map[string]int{"1": 1, "2": 2, "3": 3, "4": 4}, true)
...
func Test_StrIntMap_Iterator(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		m := fmap.NewStrIntMapFrom(expect)
...
func Test_StrIntMap_Clone(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		// clone 方法是深克隆
		m := fmap.NewStrIntMapFrom(map[string]int{"a": 1, "b": 2, "c": 3})
...
func Test_StrIntMap_Merge(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		m1 := fmap.NewStrIntMap()
		m2 := fmap.NewStrIntMap()
		m1.Set("a", 1)
		m2.Set("b", 2)
		m1.Merge(m2)
		t.Assert(m1.Map(), map[string]int{"a": 1, "b": 2})
		m3 := fmap.NewStrIntMapFrom(nil)
		m3.Merge(m2)
...
func Test_StrIntMap_Pop(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		m := fmap.NewStrIntMapFrom(f.MapStrInt{
			"k1": 11,
			"k2": 22,
		})
		t.Assert(m.Size(), 2)
...
func Test_StrIntMap_IsSubOf(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		m1 := fmap.NewStrIntMapFrom(f.MapStrInt{
			"k1": 1,
			"k2": 2,
		})
		m2 := fmap.NewStrIntMapFrom(f.MapStrInt{
			"k2": 2,
		})
