...
func (m *IntAnyMap) GetVar(key int) *fvar.Var {
	return fvar.New(m.Get(key))
}

// GetVarOrSet returns a Var with result from GetVarOrSet.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSet(key int, value interface{}) *fvar.Var {
	return fvar.New(m.GetOrSet(key, value))
}

// GetVarOrSetFunc returns a Var with result from GetOrSetFunc.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSetFunc(key int, f func() interface{}) *fvar.Var {
	return fvar.New(m.GetOrSetFunc(key, f))
}

// GetVarOrSetFuncLock returns a Var with result from GetOrSetFuncLock.
// The returned Var is un-concurrent safe.
func (m *IntAnyMap) GetVarOrSetFuncLock(key int, f func() interface{}) *fvar.Var {
...
func (m *IntAnyMap) UnmarshalValue(value interface{}) (err error) {
	...
	switch value.(type) {
	case string, []byte:
		return json.UnmarshalUseNumber(fconv.Bytes(value), &m.data)
	default:
		for k, v := range fconv.Map(value) {
			m.data[fconv.Int(k)] = v
		}
	}
	return
}
