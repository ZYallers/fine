...
func TestSortedArray_NewSortedArrayFrom(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array1 := farray.NewSortedArrayFrom(a1, func1)
		array2 := farray.NewSortedArrayFrom(a2, func2)
...
func TestNewSortedArrayFromCopy(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array1 := farray.NewSortedArrayFromCopy(a1, func1)
		array2 := farray.NewSortedArrayFromCopy(a1, func2)
		t.Assert(array1.Len(), 3)
		t.Assert(array1, []interface{}{"a", "c", "f"})
		t.Assert(array1.Len(), 3)
...
func TestNewSortedArrayRange(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		func1 := func(v1, v2 interface{}) int {
			return fconv.Int(v1) - fconv.Int(v2)
		}

		array1 := farray.NewSortedArrayRange(1, 5, 1, func1)
...
func TestSortedArray_PopLeft(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array1 := farray.NewSortedArrayFrom(
			[]interface{}{"a", "d", "c", "b"},
			futil.ComparatorString,
		)
		i1, ok := array1.PopLeft()
		t.Assert(ok, true)
		t.Assert(fconv.String(i1), "a")
		t.Assert(array1.Len(), 3)
		t.Assert(array1, []interface{}{"b", "c", "d"})
	})
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedArrayFrom(f.Slice{1, 2, 3}, futil.ComparatorInt)
		v, ok := array.PopLeft()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestSortedArray_Empty(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedArray(futil.ComparatorInt)
		v, ok := array.PopLeft()
		t.Assert(v, nil)
		t.Assert(ok, false)
...
func TestSortedArray_Range(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array1 := farray.NewSortedArrayFrom(a1, func1)
		array2 := farray.NewSortedArrayFrom(a1, func1, true)
		i1 := array1.Range(2, 5)
...
func TestSortedArray_Sum(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array1 := farray.NewSortedArrayFrom(a1, func1)
		array2 := farray.NewSortedArrayFrom(a2, func1)
		array3 := farray.NewSortedArrayFrom(a3, func1)
...
func TestSortedArray_Chunk(t *testing.T) {
	...
	ftest.C(t, func(t *ftest.T) {
		...
		array1 := farray.NewSortedArrayFrom(a1, futil.ComparatorInt)
...
func TestSortedArray_Rand(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array2 := farray.NewSortedArrayFrom([]interface{}{}, func1)
		v, ok := array2.Rand()
		t.Assert(ok, false)
		t.Assert(v, nil)
	})
...
func TestSortedArray_Join(t *testing.T) {
	...
	ftest.C(t, func(t *ftest.T) {
		...
		array1 := farray.NewSortedArrayFrom(a1, futil.ComparatorString)
...
func TestSortedArray_Unique(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array2 := farray.NewSortedArrayFrom([]interface{}{}, futil.ComparatorInt)
		array2.Unique()
...
func TestSortedArray_LockFunc(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		a1 := farray.NewSortedArrayFrom(s1, func1, true)
...
func TestSortedArray_Merge(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		a1 := farray.NewSortedArrayFrom(s1, func1)
...
func TestSortedArray_Json(t *testing.T) {
	...
	ftest.C(t, func(t *ftest.T) {
		...
		a1 := farray.NewSortedArrayFrom(s1, futil.ComparatorString)
		b1, err1 := json.Marshal(a1)
		b2, err2 := json.Marshal(s1)
		t.Assert(b1, b2)
		t.Assert(err1, err2)

		a2 := farray.NewSortedArray(futil.ComparatorString)
		err1 = json.UnmarshalUseNumber(b2, &a2)
		t.AssertNil(err1)
		t.Assert(a2.Slice(), s2)

		var a3 farray.SortedArray
...
func TestSortedArray_Iterator(t *testing.T) {
	...
	array := farray.NewSortedArrayFrom(slice, futil.ComparatorString)
	ftest.C(t, func(t *ftest.T) {
...
func TestSortedArray_UnmarshalValue(t *testing.T) {
	type V struct {
		Name  string
		Array *farray.SortedArray
	}
	// JSON
	ftest.C(t, func(t *ftest.T) {
		v := new(V)
		v.Name = "john"
		v.Array = farray.NewSortedArrayFrom([]interface{}{2, 3, 1}, futil.ComparatorInt)
...
func TestSortedArray_Filter(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array := farray.NewSortedArrayFromCopy(values, futil.ComparatorInt)
		t.Assert(array.Filter(func(index int, value interface{}) bool {
			return empty.IsNil(value)
		}).Slice(), f.Slice{0, "", f.Slice{}, 1, 2, 3, 4})
	})
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedArrayFromCopy(f.Slice{nil, 1, 2, 3, 4, nil}, futil.ComparatorInt)
		t.Assert(array.Filter(func(index int, value interface{}) bool {
			return empty.IsNil(value)
		}), f.Slice{1, 2, 3, 4})
	})
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedArrayFrom(f.Slice{0, 1, 2, 3, 4, "", f.Slice{}}, futil.ComparatorInt)
		t.Assert(array.Filter(func(index int, value interface{}) bool {
			return empty.IsEmpty(value)
		}), f.Slice{1, 2, 3, 4})
	})
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedArrayFrom(f.Slice{1, 2, 3, 4}, futil.ComparatorInt)
		t.Assert(array.Filter(func(index int, value interface{}) bool {
			return empty.IsEmpty(value)
		}), f.Slice{1, 2, 3, 4})
	})
...
func TestSortedArray_FilterNil(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		values := f.Slice{0, 1, 2, 3, 4, "", f.Slice{}}
		array := farray.NewSortedArrayFromCopy(values, futil.ComparatorInt)
		t.Assert(array.FilterNil().Slice(), f.Slice{0, "", f.Slice{}, 1, 2, 3, 4})
	})
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedArrayFromCopy(f.Slice{nil, 1, 2, 3, 4, nil}, futil.ComparatorInt)
...
func TestSortedArray_Walk(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedArrayFrom(f.Slice{"1", "2"}, futil.ComparatorString)
...
func TestSortedArray_IsEmpty(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedArrayFrom([]interface{}{}, futil.ComparatorString)
...
func TestSortedArray_DeepCopy(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedArrayFrom([]interface{}{1, 2, 3, 4, 5}, futil.ComparatorString)
		copyArray := array.DeepCopy().(*farray.SortedArray)
		array.Add(6)
		copyArray.Add(7)
