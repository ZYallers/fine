...
func Test_IntArray_Basic(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		expect := []int{0, 1, 2, 3}
		expect2 := []int{}
		array := farray.NewIntArrayFrom(expect)
		array2 := farray.NewIntArrayFrom(expect2)
	...
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewIntArrayFrom([]int{0, 1, 2, 3})
		copyArray := array.DeepCopy().(*farray.IntArray)
		copyArray.Set(0, 1)
...
func TestIntArray_Sort(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array2 := farray.NewIntArray(true)
		for i := 3; i >= 0; i-- {
			array.Append(i)
			array2.Append(i)
		}
...
func TestIntArray_Unique(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array2 := farray.NewIntArrayFrom([]int{})
...
func TestIntArray_PopLeftsAndPopRights(t *testing.T) {
	...
	ftest.C(t, func(t *ftest.T) {
		...
		array1 := farray.NewIntArrayFrom(value1)
		array2 := farray.NewIntArrayFrom(value2)
...
func TestIntArray_Range(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		value1 := []int{0, 1, 2, 3, 4, 5, 6}
		array1 := farray.NewIntArrayFrom(value1)
		array2 := farray.NewIntArrayFrom(value1, true)
...
func TestIntArray_Merge(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		s1 := []string{"a", "b", "c"}
		s2 := []string{"e", "f"}
		a1 := farray.NewIntArrayFrom(n1)
		a2 := farray.NewIntArrayFrom(n2)
		a3 := farray.NewArrayFrom(i1)
		a4 := farray.NewStrArrayFrom(s1)

		a5 := farray.NewSortedStrArrayFrom(s2)
		a6 := farray.NewSortedIntArrayFrom([]int{1, 2, 3})

		a7 := farray.NewSortedStrArrayFrom(s1)
		a8 := farray.NewSortedArrayFrom([]interface{}{4, 5}, func1)
...
func TestIntArray_Fill(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		a1 := []int{0}
		a2 := []int{0}
		array1 := farray.NewIntArrayFrom(a1)
		array2 := farray.NewIntArrayFrom(a2)
...
func TestIntArray_PopLeft(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewIntArrayFrom(f.SliceInt{1, 2, 3})
		v, ok := array.PopLeft()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestIntArray_SubSlice(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array1 := farray.NewIntArrayFrom(a1)
		array2 := farray.NewIntArrayFrom(a1, true)
...
func TestIntArray_PopRands(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array := farray.NewIntArrayFrom(a1)
...
func TestNewIntArrayFromCopy(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		a1 := []int{1, 2, 3, 5, 3}
		array1 := farray.NewIntArrayFromCopy(a1)
...
func TestIntArray_LockFunc(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		s1 := []int{1, 2, 3, 4}
		a1 := farray.NewIntArrayFrom(s1, true)
...
func TestIntArray_Json(t *testing.T) {
	...
	ftest.C(t, func(t *ftest.T) {
		...
		a2 := farray.NewIntArray()
		err1 = json.UnmarshalUseNumber(b2, &a2)
		t.AssertNil(err1)
		t.Assert(a2.Slice(), s1)

		var a3 farray.IntArray
...
func TestIntArray_Iterator(t *testing.T) {
	...
	array := farray.NewIntArrayFrom(slice)
	ftest.C(t, func(t *ftest.T) {
...
func TestIntArray_UnmarshalValue(t *testing.T) {
	type V struct {
		Name  string
		Array *farray.IntArray
	}
	// JSON
	ftest.C(t, func(t *ftest.T) {
		v := new(V)
		v.Name = "john"
		v.Array = farray.NewIntArrayFrom([]int{1, 2, 3})
...
func TestIntArray_Filter(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewIntArrayFrom(f.SliceInt{0, 1, 2, 3, 4, 0})
		t.Assert(array.Filter(func(index int, value int) bool {
			return empty.IsEmpty(value)
		}), f.SliceInt{1, 2, 3, 4})
	})
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewIntArrayFrom(f.SliceInt{1, 2, 3, 4})
		t.Assert(array.Filter(func(index int, value int) bool {
			return empty.IsEmpty(value)
...
func TestIntArray_Walk(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewIntArrayFrom(f.SliceInt{1, 2})
...
func TestIntArray_NewIntArrayRange(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewIntArrayRange(0, 128, 4)
	...
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewIntArrayRange(1, 128, 4)
