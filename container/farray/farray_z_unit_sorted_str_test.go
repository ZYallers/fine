...
func TestNewSortedStrArrayComparator(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		a1 := []string{"a", "d", "c", "b"}
		s1 := farray.NewSortedStrArrayComparator(func(a, b string) int {
			return fstr.Compare(a, b)
		})
		s1.Add(a1...)
		t.Assert(s1.Len(), 4)
...
func TestNewSortedStrArrayFrom(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		a1 := []string{"a", "d", "c", "b"}
		s1 := farray.NewSortedStrArrayFrom(a1, true)
		t.Assert(s1, []string{"a", "b", "c", "d"})
		s2 := farray.NewSortedStrArrayFrom(a1, false)
...
func TestNewSortedStrArrayFromCopy(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		a1 := []string{"a", "d", "c", "b"}
		s1 := farray.NewSortedStrArrayFromCopy(a1, true)
		t.Assert(s1.Len(), 4)
		t.Assert(s1, []string{"a", "b", "c", "d"})
	})
}
...
func TestSortedStrArray_SetArray(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		a1 := []string{"a", "d", "c", "b"}
		a2 := []string{"f", "g", "h"}
		array1 := farray.NewSortedStrArrayFrom(a1)
		array1.SetArray(a2)
...
func TestSortedStrArray_PopLeft(t *testing.T) {
	...
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedStrArrayFrom(f.SliceStr{"1", "2", "3"})
		v, ok := array.PopLeft()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestSortedStrArray_Range(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		a1 := []string{"e", "a", "d", "c", "b", "f", "g"}
		array1 := farray.NewSortedStrArrayFrom(a1)
		array2 := farray.NewSortedStrArrayFrom(a1, true)
		s1 := array1.Range(2, 4)
		t.Assert(len(s1), 2)
...
func TestSortedStrArray_Sum(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		a2 := []string{"1", "2", "3", "4", "a"}
		array1 := farray.NewSortedStrArrayFrom(a1)
		array2 := farray.NewSortedStrArrayFrom(a2)
...
func TestSortedStrArray_Rand(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		array2 := farray.NewSortedStrArrayFrom([]string{})
		v, ok = array2.Rand()
		t.Assert(v, "")
		t.Assert(ok, false)
	})
...
func TestSortedStrArray_Join(t *testing.T) {
	...
	ftest.C(t, func(t *ftest.T) {
		array1 := farray.NewSortedStrArrayFrom([]string{})
...
func TestSortedStrArray_LockFunc(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		s1 := []string{"a", "b", "c", "d"}
		a1 := farray.NewSortedStrArrayFrom(s1, true)
...
func TestSortedStrArray_Merge(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		a1 := farray.NewSortedStrArrayFrom(s1)
...
func TestSortedStrArray_Json(t *testing.T) {
	...
	ftest.C(t, func(t *ftest.T) {
		...
		a2 := farray.NewSortedStrArray()
		err1 = json.UnmarshalUseNumber(b2, &a2)
		t.AssertNil(err1)
		t.Assert(a2.Slice(), s2)
		t.Assert(a2.Interfaces(), s2)

		var a3 farray.SortedStrArray
...
func TestSortedStrArray_Iterator(t *testing.T) {
	...
	array := farray.NewSortedStrArrayFrom(slice)
	ftest.C(t, func(t *ftest.T) {
...
func TestSortedStrArray_UnmarshalValue(t *testing.T) {
	type V struct {
		Name  string
		Array *farray.SortedStrArray
	}
	// JSON
	ftest.C(t, func(t *ftest.T) {
		v := new(V)
		v.Name = "john"
		v.Array = farray.NewSortedStrArrayFrom([]string{"1", "3", "2"})
...
func TestSortedStrArray_Filter(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedStrArrayFrom(f.SliceStr{"", "1", "2", "0"})
		t.Assert(array.Filter(func(index int, value string) bool {
			return empty.IsEmpty(value)
		}), f.SliceStr{"0", "1", "2"})
	})
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedStrArrayFrom(f.SliceStr{"1", "2"})
		t.Assert(array.Filter(func(index int, value string) bool {
			return empty.IsEmpty(value)
		}), f.SliceStr{"1", "2"})
	})
...
func TestSortedStrArray_FilterEmpty(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedStrArrayFrom(f.SliceStr{"", "1", "2", "0"})
		t.Assert(array.FilterEmpty(), f.SliceStr{"0", "1", "2"})
	})
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedStrArrayFrom(f.SliceStr{"1", "2"})
...
func TestSortedStrArray_DeepCopy(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		array := farray.NewSortedStrArrayFrom([]string{"a", "b", "c", "d"})
		copyArray := array.DeepCopy().(*farray.SortedStrArray)
		array.Add("e")
		copyArray.Add("f")
