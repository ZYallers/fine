...
func TestSet_Iterator_Deadlock(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		set := fset.NewFrom([]interface{}{1, 2, 3, 4, 5}, true)
...
func TestNewFrom(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		s1 := fset.NewFrom("a")
		s2 := fset.NewFrom("b", false)
		s3 := fset.NewFrom(3, true)
		s4 := fset.NewFrom([]string{"s1", "s2"}, true)
