...
func TestStrSet_Iterator_Deadlock(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		set := fset.NewStrSetFrom([]string{"1", "2", "3", "4", "5"}, true)
...
func TestNewIntSetFrom(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		s1 := fset.NewIntSetFrom([]int{1, 2, 3, 4})
		s2 := fset.NewIntSetFrom([]int{5, 6, 7, 8})
...
func TestNewStrSetFrom(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		s1 := fset.NewStrSetFrom([]string{"a", "b", "c"}, true)
...
func TestStrSet_Sum(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		s1 := fset.NewStrSetFrom([]string{"a", "b", "c"}, true)
		s2 := fset.NewIntSetFrom([]int{2, 3, 4}, true)
		t.Assert(s1.Sum(), 0)
		t.Assert(s2.Sum(), 9)
	})
}
...
func TestStrSet_Walk(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		var (
			set    fset.StrSet
			names  = f.SliceStr{"user", "user_detail"}
			prefix = "gf_"
		)
		set.Add(names...)
...
func TestStrSet_DeepCopy(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		copySet := set.DeepCopy().(*fset.StrSet)
		copySet.Add("4")
