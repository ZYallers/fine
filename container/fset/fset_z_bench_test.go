...
var intSet = fset.NewIntSet(true)

var anySet = fset.NewSet(true)

var strSet = fset.NewStrSet(true)

var intSetUnsafe = fset.NewIntSet()

var anySetUnsafe = fset.NewSet()

var strSetUnsafe = fset.NewStrSet()
