...
func (v *Var) MapStrStr(option ...MapOption) map[string]string {
	return fconv.MapStrStr(v.Val(), option...)
}
...
func (v *Var) Maps(option ...MapOption) []map[string]interface{} {
	return fconv.Maps(v.Val(), option...)
}
...
func (v *Var) MapsDeep(tags ...string) []map[string]interface{} {
	return fconv.MapsDeep(v.Val(), tags...)
}

// MapToMap converts any map type variable `params` to another map type variable `pointer`.
// See fconv.MapToMap.
func (v *Var) MapToMap(pointer interface{}, mapping ...map[string]string) (err error) {
	return fconv.MapToMap(v.Val(), pointer, mapping...)
}

// MapToMaps converts any map type variable `params` to another map type variable `pointer`.
// See fconv.MapToMaps.
func (v *Var) MapToMaps(pointer interface{}, mapping ...map[string]string) (err error) {
	return fconv.MapToMaps(v.Val(), pointer, mapping...)
}

// MapToMapsDeep converts any map type variable `params` to another map type variable
// `pointer` recursively.
// See fconv.MapToMapsDeep.
