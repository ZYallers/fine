...
func checkListLen(t *ftest.T, l *flist.List, len int) bool {
	if n := l.Len(); n != len {
...
func checkListPointers(t *ftest.T, l *flist.List, es []*flist.Element) {
	if !checkListLen(t, l, len(es)) {
		return
	}
	l.RLockFunc(func(list *list.List) {
		for i, e := 0, l.Front(); i < list.Len(); i, e = i+1, e.Next() {
			if e.Prev() != es[i].Prev() {
...
func TestList(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		// Single element list
		e := l.PushFront("a")
		checkListPointers(t, l, []*flist.Element{e})
		l.MoveToFront(e)
		checkListPointers(t, l, []*flist.Element{e})
		l.MoveToBack(e)
		checkListPointers(t, l, []*flist.Element{e})
		l.Remove(e)
		checkListPointers(t, l, []*flist.Element{})
		...
		checkListPointers(t, l, []*flist.Element{e1, e2, e3, e4})

		l.Remove(e2)
		checkListPointers(t, l, []*flist.Element{e1, e3, e4})

		l.MoveToFront(e3) // move from middle
		checkListPointers(t, l, []*flist.Element{e3, e1, e4})

		l.MoveToFront(e1)
		l.MoveToBack(e3) // move from middle
		checkListPointers(t, l, []*flist.Element{e1, e4, e3})
		...
		checkListPointers(t, l, []*flist.Element{e2, e1, e4, e3})
		l.Remove(e2)
		e2 = l.InsertBefore(e4, 2) // insert before middle
		checkListPointers(t, l, []*flist.Element{e1, e2, e4, e3})
		l.Remove(e2)
		e2 = l.InsertBefore(e3, 2) // insert before back
		checkListPointers(t, l, []*flist.Element{e1, e4, e2, e3})
		l.Remove(e2)
		...
		checkListPointers(t, l, []*flist.Element{e1, e4, e3, e2})
		l.Remove(e2)
...
func checkList(t *ftest.T, l *flist.List, es []interface{}) {
	if !checkListLen(t, l, len(es)) {
		return
	}
...
func TestRemove(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		e1 := l.PushBack(1)
		e2 := l.PushBack(2)
		checkListPointers(t, l, []*flist.Element{e1, e2})
		// e := l.Front()
		// l.Remove(e)
...
func TestMove(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		l.MoveBefore(e2, e4)
		checkListPointers(t, l, []*flist.Element{e1, e3, e2, e4})
		e2, e3 = e3, e2

		l.MoveBefore(e4, e1)
		checkListPointers(t, l, []*flist.Element{e4, e1, e2, e3})
...
func TestInsertBeforeUnknownMark(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		l.PushBack(2)
		l.PushBack(3)
		l.InsertBefore(new(list.Element), 1)
...
func TestInsertAfterUnknownMark(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		l.PushBack(2)
		l.PushBack(3)
		l.InsertAfter(new(flist.Element), 1)
		checkList(t, l, []interface{}{1, 2, 3})
	})
}
...
func TestList_Removes(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		l.PushFronts(a1)
		e1 := l.Back()
		l.Removes([]*flist.Element{e1})
		t.Assert(l.Len(), 3)

		e2 := l.Back()
		l.Removes([]*list.Element{e2})
		t.Assert(l.Len(), 2)
...
func TestList_Pop(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		l := flist.NewFrom([]interface{}{1, 2, 3, 4, 5, 6, 7, 8, 9})
...
func TestList_IteratorAsc(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		l.PushFronts(a1)
		e1 := l.Back()
		fun1 := func(e *flist.Element) bool {
			return fconv.Int(e1.Value) > 2
		}
...
func TestList_Iterator(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		...
		l.PushFronts(a1)
		e1 := l.Back()
		fun1 := func(e *list.Element) bool {
			return fconv.String(e1.Value) > "c"
		}
...
func TestList_Join(t *testing.T) {
	ftest.C(t, func(t *ftest.T) {
		l := flist.NewFrom([]interface{}{1, 2, "a", `"b"`, `\c`})
...
func TestList_UnmarshalValue(t *testing.T) {
	...
	// JSON
	ftest.C(t, func(t *ftest.T) {
		tlist := &TList{Name: "john", List: flist.NewFrom([]interface{}{1, 2, 3})}
